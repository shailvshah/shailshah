...
export default function Home() {
  return (
    <main className="h-screen w-full snap-y snap-mandatory overflow-y-scroll bg-[var(--background)]">
      <SocialHeader />
        ...
        <div className="grid w-full max-w-6xl grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-6 rounded-sm border border-[var(--border-subtle)] bg-[var(--bg-secondary)]/40 p-8 backdrop-blur-sm transition-all hover:border-[var(--accent-core)]/30 hover:bg-[var(--bg-secondary)]/60">
            ...
            <p className="font-body text-lg leading-relaxed text-[var(--text-secondary)]">
              ...
              meets{' '}
              <span className="font-medium text-[var(--text-primary)]">engineering reality</span>. I
              bridge the gap between theoretical modeling and production—building the data backbones
              and cloud infrastructure needed to make{' '}
          ...
          <div className="flex flex-col gap-6 rounded-sm border border-[var(--border-subtle)] bg-[var(--bg-secondary)]/40 p-8 backdrop-blur-sm transition-all hover:border-[var(--accent-core)]/30 hover:bg-[var(--bg-secondary)]/60">
            ...
            <div className="flex h-full flex-col justify-between gap-4">
              ...
              <div className="font-body mt-auto border-l-2 border-[var(--accent-core)] pl-4 text-lg leading-relaxed text-[var(--text-secondary)]">
                Writing code is satisfying, but solving the business puzzle is what truly drives me.
                I thrive in <span className="text-[var(--text-primary)]">dynamic environments</span>
        ...
        <div className="w-full max-w-5xl">
          <div className="mb-12 flex flex-col gap-4">
            ...
            <p className="font-body max-w-xl text-lg text-[var(--text-secondary)]">
              My skills are built for production: separating core, data, system and user experience.
            </p>
          </div>
      ...
      >
        <div className="w-full max-w-4xl">
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="group flex flex-col justify-between gap-4 opacity-60 hover:opacity-100 md:flex-row md:items-baseline">
              <div className="md:w-1/3">
                ...
                <p className="font-mono text-sm text-[var(--text-secondary)]">Mentor & Developer</p>
              ...
              <div className="font-body max-w-lg text-[var(--text-primary)] opacity-90 md:w-2/3">
                <ul className="list-disc space-y-2 pl-4 text-base leading-relaxed text-[var(--text-secondary)]">
                  ...
                  <li>
                    ...
                    Delivered a functional Ethereum Supply Chain prototype, integrating React with
                    Solidity smart contracts.
                  </li>
                  <li>
                    <span className="font-bold text-[var(--text-primary)]">TCS (Developer):</span>{' '}
            ...
            {/* Phase 2: Enverus */}
            <div className="group flex flex-col justify-between gap-4 border-t border-[var(--border-subtle)] pt-12 opacity-70 transition-opacity hover:opacity-100 md:flex-row md:items-baseline">
              <div className="md:w-1/3">
                <h4 className="font-heading text-2xl font-bold text-[var(--text-primary)] transition-colors group-hover:text-[var(--accent-core)]">
                  Enverus
                </h4>
              ...
              <div className="font-body max-w-lg text-[var(--text-primary)] opacity-90 md:w-2/3">
                <p className="mb-4 text-base leading-relaxed">
                  ...
                  for over
                  <span className="font-medium text-[var(--text-primary)]"> 80 million assets</span>
            ...
            {/* Phase 3: SpanIdea */}
            <div className="group flex flex-col justify-between gap-4 border-t border-[var(--border-subtle)] pt-12 opacity-80 transition-opacity hover:opacity-100 md:flex-row md:items-baseline">
              <div className="md:w-1/3">
                <h4 className="font-heading text-2xl font-bold text-[var(--text-primary)] transition-colors group-hover:text-[var(--accent-core)]">
                  SpanIdea Systems
                </h4>
            ...
            {/* Phase 4: View Inc (DE) */}
            <div className="group flex flex-col justify-between gap-4 border-t border-[var(--border-subtle)] pt-12 opacity-90 transition-opacity hover:opacity-100 md:flex-row md:items-baseline">
              <div className="md:w-1/3">
              ...
              <div className="font-body max-w-lg text-[var(--text-primary)] opacity-90 md:w-2/3">
                <ul className="list-disc space-y-2 pl-4 text-base leading-relaxed text-[var(--text-secondary)]">
                  <li>
                    Unveiled key operational inefficiencies for senior leadership through automated
            ...
            <div className="group flex flex-col justify-between gap-4 border-t border-[var(--border-subtle)] pt-12 opacity-90 transition-opacity hover:opacity-100 md:flex-row md:items-baseline">
              <div className="md:w-1/3">
                ...
                <p className="font-mono text-sm text-[var(--text-secondary)]">Data Engineer II</p>
                <div className="mt-2 font-mono text-xs text-[var(--text-tertiary)]">
                  Dec 2021 — 2023
                </div>
              </div>
              <div className="font-body max-w-lg text-[var(--text-primary)] opacity-90 md:w-2/3">
                <ul className="list-disc space-y-2 pl-4 text-base leading-relaxed text-[var(--text-secondary)]">
                  <li>
                    Established a unified data architecture to ensure seamless integration across
                    diverse product lines.
                  </li>
                  <li>
                    Built an innovative resolution system for diagnosing IoT/network malfunctions,
                    leveraging SNMP telemetry and network topology to pinpoint root causes.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="group flex flex-col justify-between gap-4 border-t border-[var(--border-subtle)] pt-12 transition-opacity hover:opacity-100 md:flex-row md:items-baseline">
              <div className="md:w-1/3">
                <h4 className="font-heading text-2xl font-bold text-[var(--text-primary)] transition-colors group-hover:text-[var(--accent-core)]">
                  View, Inc.
                </h4>
                <p className="font-mono text-sm text-[var(--text-secondary)]">Senior AI Engineer</p>
                <div className="mt-2 font-mono text-xs text-[var(--text-tertiary)]">
                  2023 — 2024
                </div>
              </div>
              <div className="font-body max-w-lg text-[var(--text-primary)] opacity-90 md:w-2/3">
                <p className="mb-4 text-base leading-relaxed">
                  ...
                  , fusing Large Language Models (LLM) with Knowledge Graphs to derive actionable
                  insights from OT data.
                </p>
                <ul className="list-disc space-y-2 pl-4 text-base leading-relaxed text-[var(--text-secondary)]">
                  <li>
                    Designed a RAG architecture to query unstructured manual data against real-time
                    IoT telemetry.
                  </li>
                  <li>
                    Built the semantic layer connecting discrete building systems (HVAC, Lighting,
                    Access) into a unified Knowledge Graph.
                  </li>
                  <li>
            ...
            {/* Phase 7: Neeve */}
            <div className="group flex flex-col justify-between gap-4 border-t border-[var(--border-subtle)] pt-12 md:flex-row md:items-baseline">
              <div className="md:w-1/3">
                <h4 className="font-heading text-2xl font-bold text-[var(--text-primary)] transition-colors group-hover:text-[var(--accent-core)]">
                  Neeve
                </h4>
              ...
              <div className="font-body max-w-lg text-[var(--text-primary)] opacity-90 md:w-2/3">
                ...
                <ul className="list-disc space-y-2 pl-4 text-base leading-relaxed text-[var(--text-secondary)]">
                  ...
                  <li>
                    Led the full product lifecycle from concept to production, delivering tangible
                    automation value.
                  </li>
                </ul>
              </div>
